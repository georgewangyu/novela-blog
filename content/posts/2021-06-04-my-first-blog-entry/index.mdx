...
(Sidenote: my typing speed is garbage. I think it's the original keyboard's design problem. Can someone invent a solution that's just as fast as audio but also better in mistake correction? I probably need to do some typing exercises)
Book Recommendation:
